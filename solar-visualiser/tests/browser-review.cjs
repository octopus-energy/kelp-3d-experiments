...
(async()=>{
 ...
 const scripts=['browser-reconstruction.cjs','browser-survey.cjs','browser-ashp-workflow.cjs','browser-replay.cjs','browser-proposal.cjs','browser-installation.cjs','browser-planning.cjs','browser-room-assessment.cjs'],requested=process.argv.slice(2);
