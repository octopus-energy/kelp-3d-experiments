...
window.IMAGE_DATA = {
  ...
  images: [
    {
      id: '7414078a464769898035bfb4507ead701981bbe8', file: '7414078a464769898035bfb4507ead701981bbe8.webp',
      kind: 'exterior', side: 'front',
    ...
    },
    {
      ...
      kind: 'interior', room: { type: 'bedroom', confidence: 0.9 },
      caption: 'Double bedroom (blue) — window with radiator under',
      evidence: 'double bed, built-in wardrobe, radiator under window',
      features: { windows: [{ bbox: [0.27, 0.28, 0.19, 0.31] }], radiators: [{ bbox: [0.23, 0.60, 0.20, 0.10] }] },
    },
    {
      id: 'cef014ef9a504bcc542435f0a6ca428a7d9ab2fc', file: 'cef014ef9a504bcc542435f0a6ca428a7d9ab2fc.webp',
      kind: 'interior', room: { type: 'bedroom', confidence: 0.9 },
      ...
      features: { windows: [{ bbox: [0.28, 0.28, 0.17, 0.30] }], radiators: [{ bbox: [0.22, 0.59, 0.19, 0.10] }] },
    },
    {
      id: '5a4534239da0d0a8db5c6f5465f4ef099f5960f5', file: '5a4534239da0d0a8db5c6f5465f4ef099f5960f5.webp',
      kind: 'interior', room: { type: 'bedroom', confidence: 0.85 },
    ...
    },
    {
      ...
      features: { windows: [{ bbox: [0.04, 0.22, 0.42, 0.38] }], radiators: [{ bbox: [0.06, 0.60, 0.38, 0.20] }] },
    },
    {
      id: '20242a77b148ca0c31361fc64477d4b8dd88e4a3', file: '20242a77b148ca0c31361fc64477d4b8dd88e4a3.webp',
      kind: 'interior', room: { type: 'kitchen', confidence: 0.98 },
      caption: 'Kitchen — window over sink, appliances',
      evidence: 'units, oven, washing machine, sink under window',
      features: { windows: [{ bbox: [0.53, 0.30, 0.28, 0.22] }] },
    },
    {
      id: 'a45958365dfcb4bc63db0ab2959b923f557ccedf', file: 'a45958365dfcb4bc63db0ab2959b923f557ccedf.webp',
      kind: 'interior', room: { type: 'kitchen', confidence: 0.95 },
      caption: 'Kitchen — run of units, other direction',
      evidence: 'same lime units as the sink shot',
      features: {},
    },
    {
      id: 'f5a6127b438ddd977bd4a175cd0a925b70bdbd6f', file: 'f5a6127b438ddd977bd4a175cd0a925b70bdbd6f.webp',
      kind: 'interior', room: { type: 'kitchen', confidence: 0.9 },
      ...
      features: { radiators: [{ bbox: [0.30, 0.60, 0.10, 0.10] }], doors: [{ bbox: [0.68, 0.30, 0.17, 0.50] }] },
    },
    {
      id: '3a50ade1d303156732bfbc2ef42dd4f06ff931dd', file: '3a50ade1d303156732bfbc2ef42dd4f06ff931dd.webp',
      kind: 'interior', room: { type: 'living', confidence: 0.9, label: 'Dining Room' },
      caption: 'Dining room — sliding patio doors, radiator',
      evidence: 'dining table, patio slider to garden, radiator on side wall',
      features: { radiators: [{ bbox: [0.0, 0.62, 0.17, 0.22] }], doors: [{ bbox: [0.17, 0.17, 0.33, 0.65] }] },
    },
    {
      id: '9f7cb76267cee3ef42cb8a2ea64d06214022001b', file: '9f7cb76267cee3ef42cb8a2ea64d06214022001b.webp',
      kind: 'interior', room: { type: 'living', confidence: 0.9, label: 'Dining Room' },
      ...
      features: { radiators: [{ bbox: [0.50, 0.61, 0.10, 0.09] }], doors: [{ bbox: [0.63, 0.10, 0.32, 0.80] }] },
    },
    {
      id: 'fde4fd5b720d5c85c71803846be4a6b2a97e929c', file: 'fde4fd5b720d5c85c71803846be4a6b2a97e929c.webp',
      kind: 'interior', room: { type: 'living', confidence: 0.9, label: 'Sitting Room' },
      ...
      features: { windows: [{ bbox: [0.0, 0.25, 0.5, 0.55] }], radiators: [{ bbox: [0.53, 0.55, 0.08, 0.10] }] },
    },
  ],

  // ------------------------------------------------------------------
  // Floorplan (Metropix). Wall-centreline coordinates in image px,
  // refined against a dark-band wall detector run over the raster (the
  // printed per-room dimensions and floor areas cross-check to within
  // ~0.1 m²). The printed dimensions give absolute scale (~36 px/m);
  // orientation is left to the outline fit + user confirmation.
  //
  // `rooms` is in CARVE ORDER: the import derives one wall polyline per
  // room, and later rooms' walls may end on earlier rooms' walls (a room
  // listed before its T-junction neighbours will fail to import).
  // Rect-less rooms (labelAt) name the leftover space and carve nothing.
  // ------------------------------------------------------------------
  floorplan: {
    id: 'floorplan', file: 'floorplan.webp',
    imageSize: [546, 900],
    areas: { groundSqM: 79.0, firstSqM: 66.0, garageSqM: 13.3 },
    floors: [
      {
        name: 'Ground Floor', level: 0,
        outline: [
          [165, 29], [390, 29], [390, 40], [428, 40], [428, 181], [407, 181],
          [407, 285], [30, 285], [30, 126], [165, 126],
        ],
        rooms: [
          { label: 'Kitchen/Dining Room', type: 'kitchen', dims: [4.3, 3.8], rect: [30, 126, 165, 285] },
      ...
      },
      {
        ...
        outline: [
          [166, 514], [427, 514], [427, 644], [410, 644], [410, 770],
          [30, 770], [30, 610], [166, 610],
        ],
        rooms: [
